...
{
    public partial class UserParameter : GeneratedParameterDto<Move.Engine.Data.Models.User>
    {
        ...
        /// </summary>
        public override void MapTo(Move.Engine.Data.Models.User entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override Move.Engine.Data.Models.User MapToNew(IMappingContext context)
        {
            var entity = new Move.Engine.Data.Models.User();
            MapTo(entity, context);
            return entity;
        }
    }

    public partial class UserResponse : GeneratedResponseDto<Move.Engine.Data.Models.User>
    {
        public UserResponse() { }
        ...
        public System.Collections.Generic.ICollection<Move.Engine.Web.Models.UserRoleResponse> UserRoles { get; set; }

        /// <summary>
        /// Map from the domain object to the properties of the current DTO instance.
        /// </summary>
        public override void MapFrom(Move.Engine.Data.Models.User obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
            ...
            if ((context.IsInRoleCached("UserAdmin")))
            {
                ...
                if (propValUserRoles != null && (tree == null || tree[nameof(this.UserRoles)] != null))
                {
                    this.UserRoles = propValUserRoles
                        ...
                        .Select(f => f.MapToDto<Move.Engine.Data.Models.UserRole, UserRoleResponse>(context, tree?[nameof(this.UserRoles)])).ToList();
                }
