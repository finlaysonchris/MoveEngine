...
{
    public partial class UserInfoParameter : GeneratedParameterDto<MoveEngine.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapTo(MoveEngine.Data.Auth.UserInfo entity, IMappingContext context)
        {
        ...
        /// </summary>
        public override MoveEngine.Data.Auth.UserInfo MapToNew(IMappingContext context)
        {
            var includes = context.Includes;

            var entity = new MoveEngine.Data.Auth.UserInfo()
            {
                Roles = Roles,
    ...
    public partial class UserInfoResponse : GeneratedResponseDto<MoveEngine.Data.Auth.UserInfo>
    {
        ...
        /// </summary>
        public override void MapFrom(MoveEngine.Data.Auth.UserInfo obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
            var includes = context.Includes;
